...
<div class="header"><h4>Registrasi User Berhasil..!</h4></div>
<form enctype="multipart/form-data" method="post" action="login/add_daftar_baru">
<div class="body bg-gray">

<div class="form-group">
<label for="Module"><center>Sebelum Login, Silahkan Cek <b>Email</b> anda untuk lakukan Verifikasi akun. Terimkasih!</center></label>
</div>	
