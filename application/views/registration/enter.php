<!-- Right side column. Contains the navbar and content of the page -->
	<aside class="right-side">
		...
		<section class="content">
			<div class="row">
				<div class="col-xs-12">
					<?php echo form_open('registration/enter/search'); ?>
							...
							<table id="example1" class="table table-bordered table-hover">
								<thead>
									<tr>
										...
										<th style="padding:4px; vertical-align:middle;">No Kodefikasi</th>
										<th style="padding:4px; vertical-align:middle;">Status</th>
										<th style="padding:4px; vertical-align:middle;">PDF</th>
									</tr>
								</thead>
								<tbody>
								<?php 
								//if (is_array($dataReg)) {
									//foreach($dataReg['data'] as $item){ 
									foreach($dataReg->result_array() as $item){
										...
										<tr>
											...
											<td style="padding:4px; vertical-align:middle;"><?php echo jarvis_permission('detailReg',$permission,array('id'=>jarvis_encode($item['Id']),'p_name'=>$item['p_name']));?></td>
											...
											<td style="padding:4px; vertical-align:middle;"><?php echo $item['sum_pdf'];?> File</td>
										</tr>
										<?php
									} 
								//}
